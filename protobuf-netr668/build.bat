...
echo.
echo 将dll移到客户端项目中
echo f|xcopy ..\DllFile\PBMessage.dll ..\..\Assets\Plugins\protobuf-net\PBMessage.dll /d /y
echo f|xcopy ..\DllFile\PBMessageSerializer.dll ..\..\Assets\Plugins\protobuf-net\PBMessageSerializer.dll /d /y
